...
def main():
    ...
    parser.add_argument('--config', default="megaface", help='the name of config file')#####配置文件这里调整

    #如果不合适，probe_list下面调整
    parser.set_defaults(model=MODEL, num_sets=1, sizes=[10, 100, 1000, 10000, 100000, 1000000], probe_list='./devkit/templatelists/facescrub_features_list.json', distractor_list_path=os.path.dirname(MEGAFACE_LIST_BASENAME))
